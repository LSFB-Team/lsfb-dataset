...
- **LSFBIsolConfig** : [dataclass](https://docs.python.org/3/library/dataclasses.html) allowing to configure how the dataset will be loaded
- **LSFBIsolBase** : Base class for all the lsfb_isol iterators.
